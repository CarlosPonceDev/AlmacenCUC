  ...
  <tbody>
    @foreach($repairs as $repair)
      <tr>
        ...
        <td> @if ($repair->product && $repair->product->full_code) {{ $repair->product->full_code }} @else <i style="color: #6c757d;">N/A</i></td> @endif
        <td> @if ($repair->product && $repair->product->description && $repair->product->description != '') {{ $repair->product->description }} @else <i style="color: #6c757d;">N/A</i></td> @endif
